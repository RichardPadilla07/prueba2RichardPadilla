...
import { chatbubbleOutline, timeOutline, checkmarkCircleOutline, closeCircleOutline, trashOutline, banOutline, receiptOutline, calendarOutline, cashOutline, wifiOutline, callOutline, ribbonOutline } from 'ionicons/icons';
...
export class MisContratacionesPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    addIcons({ chatbubbleOutline, timeOutline, checkmarkCircleOutline, closeCircleOutline, trashOutline, banOutline, receiptOutline, calendarOutline, cashOutline, wifiOutline, callOutline, ribbonOutline });
  }
