...
import { chatbubbleOutline, timeOutline, checkmarkCircleOutline, closeCircleOutline, personOutline, callOutline, banOutline } from 'ionicons/icons';
...
export class ContratacionesAsesorPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    addIcons({ chatbubbleOutline, timeOutline, checkmarkCircleOutline, closeCircleOutline, personOutline, callOutline, banOutline });
  }
